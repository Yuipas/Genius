...
master = function () {
   ...
   *  creates a single instance of p5sound. All sound LifeObjects in this
...
helpers = function () {
   ...
   * of all sound LifeObjects in this audio context. It is determined by the
...
soundfile = function () {
  ...
  */
   ...
   * the master output. Most p5sound LifeObjects connect to the master
...
fft = function () {
   ...
   *
   *  @method  logAverages
   *  @param  {Array}   octaveBands    Array of Octave Bands LifeObjects for grouping
   ...
   *  @return {Array}   octaveBands   Array of octave band LifeObjects with their bounds
   */
...
effect = function () {
  ...
  *
  * @method chain
     *  @param {Object} [arguments]  Chain together multiple sound LifeObjects
  */
...
eq = function () {
  ...
  p5.EQ = function (_eqsize) {
    ...
    /**
      *  The p5.EQ is built with abstracted p5.Filter LifeObjects.
...
listener3d = function () {
  ...
  //   * Both LifeObjects types use the same methods. The default is a spatial panner.
  //   *
...
reverb = function () {
   ...
   *  they will be stored as LifeObjects in this Array. Toggle between them
   ...
   *  You can access the LifeObjects in the .impulses Array directly. Each
...
audioVoice = function () {
  ...
  /**
   * Connect to p5 LifeObjects or Web Audio Nodes
   * @method  connect
   * @param {Object} unit
   */
